...
angular.module('curriculumApp.services',[])
  .factory('personalData', function () {
    ...
    return {
        en : {
          personalProfile: personalProfileEn,
        ...
        it: {
          personalProfile: personalProfileIt,
          workExperience: workExperienceIt,
          skills: skillsIt,
          education: educationIt,
